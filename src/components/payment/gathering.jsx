            ...
            <div className="Pay">
                ...
                <div className="wrap">
                    <div className="detail">
                        ...
                        <div className="total">
                            张三李四向您购买了123453个USDT
                        </div>
                        <p className="unit">单价 : 600/300 USDT</p>
                        <p className="gross">总价 : <span>500</span> USDT</p>
                        {/* <h2>选择支付方式</h2> */}
                        <div className="go_pay">
                            {!this.state.isAwait ? <div className="button" onClick={this.Gopay.bind(this)}>放币</div>
                            : <div className="button await">交易完成</div>    
                            }   
                ...
                {this.state.isShow ? <div className="confirm">
                    <div className="frame gathering">
                        <div className="top">
                            确认付款并放行
                        </div>
                        <p className="tip">请务必登录网上银行或第三方支付账号确认收到该笔款项</p>
                        <p className="tip">请输入资金密码</p>
                        <input type="password"/>
                        <div className="bottom">
